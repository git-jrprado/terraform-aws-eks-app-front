...
This terraform module is an AWS EKS Application Module (frontend component).
...
| lb\_cloudfront\_key | Key generated by terraform-aws-ecs module to allow ALB connection from CloudFront | `any` | n/a | yes |
| lb\_dns\_name | ALB DNS Name that CloudFront will point as origin | `any` | n/a | yes |
...
| cluster\_name | Name of existing EKS Cluster to deploy this app to | `any` | n/a | yes |
...
| name | Name of your EKS service | `any` | n/a | yes |
